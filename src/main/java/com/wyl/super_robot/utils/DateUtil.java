...
public class DateUtil {
    ...
    /**
     * 日期格式，年月日时分秒，例如：2005-05-10-23-20-00
     */
    ...
    public static boolean validateIsDate(String strTime) {
        ...
        if (date != null) {
            System.out.println(
                    "生成的日期:" + DateUtil.parseDateToStr(date, DateUtil.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS, "--null--"));
            return true;
        }
        return false;
    }
    ...
    public static Long getSecondsTime(Date time) {
        if (time == null) {
            return null;
        }
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        ...
        Long aLong = ((time.getTime() - d.getTime()) / 1000);
        return aLong;
    }
}
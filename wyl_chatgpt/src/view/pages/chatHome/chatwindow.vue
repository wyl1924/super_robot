    ...
    export default {
        ...
        methods: {
            ...
            websocketonmessage(e) {
                ...
                let _this = this
                const content = e.data; // 获取"content"字段的值
            ...
            async chatCompletion(params, chatBeforResMsg) {
                ...
                try {
                    if (this.settingInfo.chat.stream) {
                        params.key = this.settingInfo.KeyMsg;
                    ...
                    else if (this.settingInfo.chat.stream) {
                        await fetch(
                            base.baseUrl + '/chat/completions', {
                            method: "POST",
                            body: JSON.stringify({
                                ...params
                            }),

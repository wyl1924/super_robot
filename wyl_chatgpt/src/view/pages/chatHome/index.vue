  ...
  <div class="chatHome">
    ...
    <div class="chatLeft" v-show="showSetupList">
      ...
      <div class="online-person">
        <el-row :gutter="20">
          <el-col :span="8" v-for="(setting, index) in getSettings" :key="index"> <span class="setting"
...
import { getModels, getMoneyInfo, getFilesList, uploadFile, createFineTune, cancelFineTune, deleteFineTuneModel, retrieveFineTune, deleteFile, retrieveFile, retrieveFileContent, getRoles } from "@/api/getData";
...
export default {
  ...
  data() {
    return {
      ...
      SettingInfo: {
        cutSetting : 1,
          KeyMsg: "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",//process.env.VUE_APP_OPENAI_API_KEY,
        readefile: false,
        inputStatus: true,

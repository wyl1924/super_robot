...
export const createImageVariations = (formData, token) => {
  return axios({
    method: 'post',
    baseURL: `${baseUrl}/images/variations`,
    headers: {
      'Authorization': 'Bearer ' + token,
      'Content-Type': 'multipart/form-data'
    },
...
export const createTranslation = (formData, token) => {
  return axios({
    method: 'post',
    baseURL: `${baseUrl}/audio/translations`,
    headers: {
      'Authorization': 'Bearer ' + token,
      'Content-Type': 'multipart/form-data'
    },
...
export const retrieveFineTune = (fineTuneId, token) => {
  return axios({
    method: 'get',
    baseURL: `${baseUrl}/fine-tunes/` + fineTuneId,
    headers: {
      'Authorization': 'Bearer ' + token,
      'Content-Type': 'application/json'
    }
...
export const cancelFineTune = (fineTuneId, token) => {
  return axios({
    method: 'post',
    baseURL: `${baseUrl}/fine-tunes/` + fineTuneId + '/cancel',
    headers: {
      'Authorization': 'Bearer ' + token,
      'Content-Type': 'application/json'
    }
...
export const getFineTuneEventsList = (fineTuneId, token) => {
  return axios({
    method: 'get',
    baseURL: `${baseUrl}/fine-tunes/` + fineTuneId + '/events',
    headers: {
      'Authorization': 'Bearer ' + token,
      'Content-Type': 'multipart/form-data'
    },
